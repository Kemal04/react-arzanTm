                        ...
                        <div className='col-xl-12 col-lg-12 col-md-12 col-12'>
                            <div className='row'>
                                ...
                                <div className='col-xl-auto ms-auto'>
                                    <Link to="/admin/app/banner-create" className='btn btn-primary btn-sm rounded-3' style={{ fontSize: "14px", width: "140px", backgroundColor: "#000AFF" }}><FontAwesomeIcon icon={faPlus} /> Add Banner</Link>
                                </div>
                            </div>
                        </div>
                        <div className='col-xl-12 mt-5'>
                            <div className='d-flex justify-content-center align-items-center'>
                                <Link to="/admin/web/banners" className='text-dark px-3 py-2 small text-decoration-none rounded-2 me-4' style={{ border: "1px solid #000AFF" }}>
                                    <FontAwesomeIcon icon={faGlobe} className='me-2' />
                                    Web Banner
                                </Link>
                                <Link to="/admin/app/banners" className='text-white px-3 py-2 small text-decoration-none rounded-2 ms-4' style={{ backgroundColor: "#000AFF" }}>
