                        ...
                        <div className='col-xl-9 col-lg-9 col-md-9 col-12'>
                            <div className='row'>
                                <div className='col-xl-3 small'>
                                    <Link to="/admin/gallery/video" className='d-flex align-items-center justify-content-center py-1 px-2 rounded-2 small fw-bold text-white text-decoration-none' style={{ border: "1px solid #7280FF", backgroundColor: "#000AFF" }}>
                                        <FontAwesomeIcon icon={faVideo} className='me-1' />
                                        Video Galleery
                                    </Link>
                                </div>
                                <div className='col-xl-3 small'>
                                    <Link to="/admin/gallery/photo" className='d-flex align-items-center justify-content-center py-1 px-2 rounded-2 small fw-bold text-dark text-decoration-none' style={{ border: "1px solid #7280FF" }}>
                                ...
                                <div className='col-xl-6'>
                                    <div className='d-flex justify-content-end'>
                                        <Link to="/admin/gallery/video-create" className='d-flex align-items-center justify-content-center py-1 px-2 rounded-2 small fw-bold text-white text-decoration-none' style={{ border: "1px solid #7280FF", backgroundColor: "#000AFF" }}>
